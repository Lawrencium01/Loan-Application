...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" id="frmlogin">
			...
			<div class="form-actions">
				<button type="button" class="btn blue pull-right" id="btnLogin">
	...
	<script>
		...
		jQuery(document).ready(function() {     
		  ...
		  $("#btnLogin").click(function(){
			  ...
			  if (username == '' || password == ''){
				  ...
				  var frmData = $("#frmlogin").serialize() + "&TC=UL";
				   $.post("managetransactions.php",frmData).done(function(data){
					   if (data==0){
		...
		function auto_get_last_user(){
			var frmData = "TC=LU";
			$.post("managetransactions",frmData).done(function(data){				
				$("#username").val(data);
			});
		}
