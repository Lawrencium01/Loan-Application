						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form id="frmobj" class="form-horizontal">
									...
									<h3 class="block" style="color:red;">Basic Customers Information</h3>
									<hr>	
									<div class="control-group">
										<label class="control-label">Refernce Number</label>
										<div class="controls">
									...
									<h3 class="block" style="color:red;">Payment Section</h3>
									<hr>
									<div class="control-group">
...
<script>
	...
	$("#ref_no").keyup(function(){
		...
		var frmValues = "ref_no=" + ref_no +"&PT="+'PY';
	...
	$("#btnsave").click(function(){
	   ...
	   if (amount==''||particulars==''||transactiondate=='' || ref_no=='' ||email=='' || name==''){
		   var msg = "One or more inputs are empty or not correct";
		   alert(msg);				
	   }else{
		   var frmValues = $("#frmobj").serialize()+ "&PT="+'PM';
