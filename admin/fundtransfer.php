...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>FUND TRANSFER</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="frmobj" class="form-horizontal">
									<input type="hidden" name="regtag" id="regtag" value="0">
									<h3 class="block" style="color:red;">Benefactor Abridged Information</h3>
									<hr>	
									<div class="control-group">
										<label class="control-label">Account Number</label>
										<div class="controls">
											<input type="text" class="span3 m-wrap" name="accountno1" id="accountno1"   maxlength="10" />
										</div>
									</div>										
									<div class="control-group">
										<label class="control-label">Account Name</label>
										<div class="controls">
											<input type="text" class="span6 m-wrap" name="accountname1" id="accountname1"  readonly="true" />
										</div>
									</div>
									<div class="control-group">
									...
									<hr>
									<h3 class="block" style="color:red;">Beneficiary Abridged Information</h3>
									<hr>
									<div class="control-group">
										<label class="control-label">Account Number</label>
										<div class="controls">
											<input type="text" class="span3 m-wrap" name="accountno2" id="accountno2"   maxlength="10" />
										</div>
									</div>										
									<div class="control-group">
										<label class="control-label">Account Name</label>
										<div class="controls">
											<input type="text" class="span6 m-wrap" name="accountname2" id="accountname2"  readonly="true" />
										</div>
									</div>
									<hr>
									<h3 class="block" style="color:red;">Fund Transfer Section</h3>
									<hr>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span3 m-wrap" name="amount" id="amount" onkeypress="return restrictAlphabets(event);" />
										</div>
									</div>	
									<div class="control-group">
										<label class="control-label">Particulars</label>
										<div class="controls">
											<input type="text" class="span12 m-wrap" name="particulars" id="particulars"  />
										</div>
									</div>										
    ...
    <?= include("myjs.php") ?> 
	<script src="assets/scripts/fundtransfer.js" type="text/javascript"></script>   
</body>
<!-- END BODY -->
</html>