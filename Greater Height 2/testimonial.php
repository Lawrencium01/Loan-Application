...
<!-- Mirrored from jituchauhan.com/borrow/bootstrap-4/testimonial.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Mar 2020 11:22:48 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="wrapper-content bg-white pinside60">
                        <div class="row">
                           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="testimonial-block mb30">
                                    <div class="bg-white outline pinside30 mb20">
                                        <p class="testimonial-text">“You guys have never failed at the most crucial time. Greaterheight rocks. 🙌 💪<br><br>
                                            T. O.”</p>
                                    </div>
                                    <!-- <div class="testimonial-autor-box mb30">
                                        <div class="testimonial-img"> <img src="images/testimonial-img.jpg" alt="Borrow - Loan Company Website Template"> </div>
                                        <div class="testimonial-autor">
                                            <h4 class="testimonial-title">Lindo E. Olson</h4>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="testimonial-block mb30">
                                    <div class="bg-white outline pinside30 mb20">
                                        <p class="testimonial-text"> “It's well okay ma and cooperate. More grace and strength for growth and expansion to you and the organization in Jesus Mighty Name, Amen.<br>
                                            F. A..”</p>
                                    </div>
                                    <!-- <div class="testimonial-autor-box mb30">
                                        <div class="testimonial-img"> <img src="images/testimonial-img-1.jpg" alt="Borrow - Loan Company Website Template"> </div>
                                        <div class="testimonial-autor">
                                            <h4 class="testimonial-title">Lindo E. Olson</h4>
                                            <span class="testimonial-meta">Car Loan</span> </div>
                                    </div> -->
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="testimonial-block mb30">
                                    ...
                                    <!-- <div class="testimonial-autor-box mb30">
                                        <div class="testimonial-img"> <img src="images/testimonial-img-2.jpg" alt="Borrow - Loan Company Website Template"> </div>
                                        <div class="testimonial-autor">
                                            <h4 class="testimonial-title">Lindo E. Olson</h4>
                                            <span class="testimonial-meta">Car Loan</span> </div>
                                    </div> -->
                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="testimonial-block mb30">
                                    <div class="bg-white outline pinside30 mb20">
                                        <p class="testimonial-text">“Of a truth, I really enjoyed your services. Timely response to request and very simplified processes. Excellent customer service. It's well appreciated.”</p>
                                    </div>
                                    <!-- <div class="testimonial-autor-box mb30">
                                        <div class="testimonial-img"> <img src="images/testimonial-img.jpg" alt="Borrow - Loan Company Website Template"> </div>
                                        <div class="testimonial-autor">
                             ...
                             <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="testimonial-block mb30">
                                    <div class="bg-white outline pinside30 mb20">
                                        <p class="testimonial-text">“Mine is Continuous 😁 shey you dey wine me ni😂😂😂. Greater Heights is the best Jare 🙌🙌🙌 Tuale to the wonderful CEO”</p>
                                    </div>
                                    <!-- <div class="testimonial-autor-box mb30">
                                        <div class="testimonial-img"> <img src="images/testimonial-img-2.jpg" alt="Borrow - Loan Company Website Template"> </div>
                                        <div class="testimonial-autor">
