...
<!-- Mirrored from jituchauhan.com/borrow/bootstrap-4/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Mar 2020 11:22:34 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="about-section pinside40">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    ...
                                    <p class="lead mb30">Greater Height was birth as the loan arm of our product.
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="mb60">
                                        ...
                                        <p class="lead mb30">At Greater Height we make our clients as the live wire of the business our credit is easily accessible, disbursement is within 24 working hours, our rate is competitive and our tenure is 120 days maximum while the minimum loan amount we give is N50000.</p>
                                ...
                                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                                    <div class="text-center section-space80">
                                        <h2>Our Vision </h2>
                                        <p>To be the preferred financial service provider by improving the all round financial status of our clients through provision of timely, readily available, competitive and beneficial financial services.</p>
                                    </div>
                                </div>
                                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                                    <div class="text-center section-space80">
                                        <h2>Our Mission</h2>
                                        <p>Offer of various categories of savings to meet our clients need, Quick credit for our clients with regular and verifiable source of income.
                                            Expansion credit facility for business owner.
                                            Financial consultancy services.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="bg-white bg-boxshadow pinside40 outline text-center mb30">
                                            ...
                                            <a href="index-4-students-loan.php" class="btn-link">Get Appointment</a> </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="bg-white bg-boxshadow pinside40 outline text-center mb30">
                                            <div class="mb40"><i class="icon-phone-call icon-2x icon-default"></i></div>
                                            <h2 class="capital-title">Call us at </h2>
                                            <h1 class="text-big">+234 803-579-4364</h1>
                                            <p>Gttrusthelpdesk@gmail.com</p>
                                            <a href="contact-us.php" class="btn-link">Contact us</a> </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="bg-white bg-boxshadow pinside40 outline text-center mb30">
